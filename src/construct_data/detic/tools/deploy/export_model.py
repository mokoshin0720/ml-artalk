...
from construct_data.detic.detectron2.data import build_detection_test_loader, detection_utils
from construct_data.detic.detectron2.evaluation import COCOEvaluator, inference_on_dataset, print_csv_format
from construct_data.detic.detectron2.export import (
    STABLE_ONNX_OPSET_VERSION,
    TracingAdapter,
    dump_torchscript_IR,
    scripting_with_instances,
)
from construct_data.detic.detectron2.modeling import GeneralizedRCNN, RetinaNet, build_model
from construct_data.detic.detectron2.modeling.postprocessing import detector_postprocess
from construct_data.detic.detectron2.projects.point_rend import add_pointrend_config
from construct_data.detic.detectron2.structures import Boxes
from construct_data.detic.detectron2.utils.env import TORCH_VERSION
from construct_data.detic.detectron2.utils.file_io import PathManager
...
def export_caffe2_tracing(cfg, torch_model, inputs):
    from construct_data.detic.detectron2.export import Caffe2Tracer
