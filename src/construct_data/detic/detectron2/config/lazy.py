...
from construct_data.detic.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from construct_data.detic.detectron2.config import instantiate, LazyCall
