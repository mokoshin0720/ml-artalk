...
from construct_data.detic.detectron2.layers import ShapeSpec, move_device_like
from construct_data.detic.detectron2.structures import Boxes, RotatedBoxes
