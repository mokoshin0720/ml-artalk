...
from construct_data.detic.detectron2.modeling.backbone import RegNet
from construct_data.detic.detectron2.modeling.backbone.regnet import SimpleStem, ResBottleneckBlock
