...
from construct_data.detic.detectron2.modeling import PROPOSAL_GENERATOR_REGISTRY
from construct_data.detic.detectron2.modeling.proposal_generator.rpn import RPN
