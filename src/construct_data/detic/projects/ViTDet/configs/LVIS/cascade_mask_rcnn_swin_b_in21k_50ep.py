from construct_data.detic.detectron2.config.lazy import LazyCall as L
from construct_data.detic.detectron2.data.detection_utils import get_fed_loss_cls_weights
from construct_data.detic.detectron2.data.samplers import RepeatFactorTrainingSampler
from construct_data.detic.detectron2.evaluation.lvis_evaluation import LVISEvaluator
