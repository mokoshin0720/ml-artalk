...
from construct_data.detic.detectron2.data import DatasetCatalog, MetadataCatalog
from construct_data.detic.detectron2.data.datasets.builtin import _get_builtin_metadata
from construct_data.detic.detectron2.data.datasets.coco import load_coco_json
