...
from construct_data.detic.detectron2.modeling.backbone import BACKBONE_REGISTRY
from construct_data.detic.detectron2.modeling.backbone.backbone import Backbone
