...
If the error comes from construct_data.detic.detectron2 or torchvision that you built manually from source,
...
Or, if you are running code from construct_data.detic.detectron2's root directory, `cd` to a different one.
