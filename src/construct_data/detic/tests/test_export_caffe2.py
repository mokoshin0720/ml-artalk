...
from construct_data.detic.detectron2.utils.testing import get_sample_coco_image
...
try:
    ...
    from construct_data.detic.detectron2.export import Caffe2Model, Caffe2Tracer
except ImportError:
