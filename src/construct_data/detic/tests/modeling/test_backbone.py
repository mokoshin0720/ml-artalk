...
from construct_data.detic.detectron2.modeling.backbone import build_resnet_backbone
from construct_data.detic.detectron2.modeling.backbone.fpn import build_resnet_fpn_backbone
