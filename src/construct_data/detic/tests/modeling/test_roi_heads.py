...
from construct_data.detic.detectron2.export.torchscript_patch import (
    freeze_training_mode,
    patch_builtin_len,
    patch_instances,
)
from construct_data.detic.detectron2.layers import ShapeSpec
from construct_data.detic.detectron2.modeling.proposal_generator.build import build_proposal_generator
from construct_data.detic.detectron2.modeling.roi_heads import (
    FastRCNNConvFCHead,
...
from construct_data.detic.detectron2.projects import point_rend
from construct_data.detic.detectron2.structures import BitMasks, Boxes, ImageList, Instances, RotatedBoxes
from construct_data.detic.detectron2.utils.events import EventStorage
from construct_data.detic.detectron2.utils.testing import assert_instances_allclose, random_boxes
