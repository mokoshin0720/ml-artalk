...
from construct_data.detic.detectron2.config import LazyConfig, instantiate, LazyCall as L
from construct_data.detic.detectron2.layers import ShapeSpec
from construct_data.detic.detectron2.utils.testing import reload_lazy_config
