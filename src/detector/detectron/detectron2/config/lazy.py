...
from detector.detectron.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from detector.detectron.detectron2.config import instantiate, LazyCall
