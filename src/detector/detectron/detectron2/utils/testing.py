...
from detector.detectron.detectron2.config import CfgNode, LazyConfig, instantiate
from detector.detectron.detectron2.data import DatasetCatalog
...
from detector.detectron.detectron2.structures import Boxes, Instances, ROIMasks
