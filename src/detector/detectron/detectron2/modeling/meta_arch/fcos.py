...
from detector.detectron.detectron2.layers import ShapeSpec, batched_nms
from detector.detectron.detectron2.structures import Boxes, ImageList, Instances, pairwise_point_box_distance
