...
from detector.detectron.detectron2.config import LazyConfig, get_cfg, instantiate
from detector.detectron.detectron2.data import (
    DatasetFromList,
    build_detection_test_loader,
    build_detection_train_loader,
)
from detector.detectron.detectron2.data.benchmark import DataLoaderBenchmark
from detector.detectron.detectron2.engine import AMPTrainer, SimpleTrainer, default_argument_parser, hooks, launch
from detector.detectron.detectron2.modeling import build_model
from detector.detectron.detectron2.solver import build_optimizer
...
from detector.detectron.detectron2.utils.events import CommonMetricPrinter
