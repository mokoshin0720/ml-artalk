...
If the error comes from detector.detectron.detectron2 or torchvision that you built manually from source,
...
Or, if you are running code from detector.detectron.detectron2's root directory, `cd` to a different one.
