...
from detector.detectron.detectron2.structures import BoxMode
from detector.detectron.detectron2.utils.comm import gather, get_rank, is_main_process, synchronize
