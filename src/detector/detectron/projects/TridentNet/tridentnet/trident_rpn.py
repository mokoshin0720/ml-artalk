...
from detector.detectron.detectron2.modeling import PROPOSAL_GENERATOR_REGISTRY
from detector.detectron.detectron2.modeling.proposal_generator.rpn import RPN
