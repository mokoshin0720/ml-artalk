...
from detector.detectron.detectron2.layers import Conv2d, ShapeSpec, cat, interpolate
from detector.detectron.detectron2.modeling import ROI_MASK_HEAD_REGISTRY
from detector.detectron.detectron2.modeling.roi_heads.mask_head import mask_rcnn_inference, mask_rcnn_loss
