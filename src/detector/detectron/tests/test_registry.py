...
from detector.detectron.detectron2.modeling.meta_arch import GeneralizedRCNN
from detector.detectron.detectron2.utils.registry import _convert_target_to_string, locate
...
class TestLocate(unittest.TestCase):
    ...
    def test_compress_target(self):
        from detector.detectron.detectron2.data.transforms import RandomCrop
