...
import detector.detectron.detectron2.export.torchscript  # apply patch # noqa
...
from detector.detectron.detectron2.modeling.backbone import build_resnet_backbone
from detector.detectron.detectron2.modeling.backbone.fpn import build_resnet_fpn_backbone
