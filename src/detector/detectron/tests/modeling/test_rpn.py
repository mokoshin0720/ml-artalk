...
from detector.detectron.detectron2.export import scripting_with_instances
...
from detector.detectron.detectron2.modeling.proposal_generator import RPN, build_proposal_generator
from detector.detectron.detectron2.modeling.proposal_generator.proposal_utils import (
    add_ground_truth_to_proposals,
    find_top_rpn_proposals,
)
from detector.detectron.detectron2.structures import Boxes, ImageList, Instances, RotatedBoxes
