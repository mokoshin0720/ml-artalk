...
from detector.detectron.detectron2.structures import BitMasks, Boxes, ImageList, Instances
from detector.detectron.detectron2.utils.events import EventStorage
from detector.detectron.detectron2.utils.testing import get_model_no_weights
