...
from detector.detectron.detectron2.export.torchscript_patch import (
    freeze_training_mode,
    patch_builtin_len,
    patch_instances,
)
from detector.detectron.detectron2.layers import ShapeSpec
from detector.detectron.detectron2.modeling.proposal_generator.build import build_proposal_generator
from detector.detectron.detectron2.modeling.roi_heads import (
    FastRCNNConvFCHead,
...
from detector.detectron.detectron2.projects import point_rend
from detector.detectron.detectron2.structures import BitMasks, Boxes, ImageList, Instances, RotatedBoxes
from detector.detectron.detectron2.utils.events import EventStorage
from detector.detectron.detectron2.utils.testing import assert_instances_allclose, random_boxes
