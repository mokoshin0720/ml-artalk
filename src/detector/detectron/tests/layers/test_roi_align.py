...
from detector.detectron.detectron2.layers.roi_align import ROIAlign, roi_align
...
def grid_sample_roi_align(input, boxes, output_size, scale, sampling_ratio):
    ...
    from detector.detectron.detectron2.projects.point_rend.point_features import (
