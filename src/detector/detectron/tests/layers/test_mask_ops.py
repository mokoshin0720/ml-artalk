...
from detector.detectron.detectron2.layers.mask_ops import (
    pad_masks,
    paste_mask_in_image_old,
    paste_masks_in_image,
    scale_boxes,
)
from detector.detectron.detectron2.structures import BitMasks, Boxes, BoxMode, PolygonMasks
from detector.detectron.detectron2.structures.masks import polygons_to_bitmask
from detector.detectron.detectron2.utils.file_io import PathManager
from detector.detectron.detectron2.utils.testing import random_boxes
