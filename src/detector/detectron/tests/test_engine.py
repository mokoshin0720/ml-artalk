...
from detector.detectron.detectron2.config import configurable, get_cfg
from detector.detectron.detectron2.engine import DefaultTrainer, SimpleTrainer, default_setup, hooks
from detector.detectron.detectron2.modeling.meta_arch import META_ARCH_REGISTRY
from detector.detectron.detectron2.utils.events import CommonMetricPrinter, JSONWriter
