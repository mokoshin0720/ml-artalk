...
from detector.detic.detic.data.tar_dataset import DiskTarDataset, _TarDataset

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--imagenet_dir", default='data/imagenet/ImageNet-21k/')
    parser.add_argument("--tarfile_path", default='data/imagenet/metadata-22k/tar_files.npy')
    parser.add_argument("--tar_index_dir", default='data/imagenet/metadata-22k/tarindex_npy')
    parser.add_argument("--out_path", default='data/imagenet/annotations/imagenet-22k_image_info.json')
