...
def debug_test(
    ...
    for i in range(len(images)):
        ...
        for l in range(L):
            ...
            if debug_show_name:
                from detector.detectron.detectron2.data.datasets.lvis_v1_categories import LVIS_CATEGORIES 
...
def debug_second_stage(images, instances, proposals=None, vis_thresh=0.3, 
    ...
    if 'COCO' in save_debug_path:
        from detector.detectron.detectron2.data.datasets.builtin_meta import COCO_CATEGORIES
