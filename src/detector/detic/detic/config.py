...
from detector.detectron.detectron2.config import CfgNode as CN
...
def add_detic_config(cfg):
    ...
    _C.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_PATH = 'src/detector/detic/datasets/metadata/lvis_v1_clip_a+cname.npy'
