...
from detector.detectron.detectron2.data import build_detection_test_loader, detection_utils
from detector.detectron.detectron2.evaluation import COCOEvaluator, inference_on_dataset, print_csv_format
from detector.detectron.detectron2.export import TracingAdapter, dump_torchscript_IR, scripting_with_instances
from detector.detectron.detectron2.modeling import GeneralizedRCNN, RetinaNet, build_model
from detector.detectron.detectron2.modeling.postprocessing import detector_postprocess
from detector.detectron.detectron2.projects.point_rend import add_pointrend_config
from detector.detectron.detectron2.structures import Boxes
from detector.detectron.detectron2.utils.env import TORCH_VERSION
...
def export_caffe2_tracing(cfg, torch_model, inputs):
    from detector.detectron.detectron2.export import Caffe2Tracer
